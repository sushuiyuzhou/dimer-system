...
(** :: Package :: **)
(* Dimer System V-0.0, 01/02/2017 *)
(* Authors: Chuang Sun, Yan Xiao *)
(* The package comes along with the paper XXX by XXXXXXX *)
...
DimerSystem::usage="A Dimer System containing the following modules:
1) RecDimerModels[]
2) ToricInfo[]
...
newnewdimer=Show[granewlines,newgrablacknodes,newgrawhitenodes,newgrawhitenodes2,grafaces,gratoricunit/.RGBColor[1,0.85`,0.85`]->Red,PlotRange->Transpose[{leftbottom-{1,1},righttop+{2,2}}]];
